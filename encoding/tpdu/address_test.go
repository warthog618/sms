...
func TestAddressMarshalBinary(t *testing.T) {
	patterns := []addressMarshalPattern{
		...
		{"alpha", tpdu.Address{Addr: "messages", TOA: 0xd1}, []byte{14, 0xd1, 0xED, 0xF2, 0x7C, 0x1E, 0x3E, 0x97, 0xE7}, nil},
		{"alpha odd", tpdu.Address{Addr: "message", TOA: 0xd1}, []byte{13, 0xd1, 0xED, 0xF2, 0x7C, 0x1E, 0x3E, 0x97, 0x01}, nil},
		{"alpha Vodafone", tpdu.Address{Addr: "Vodafone", TOA: 0xd0}, []byte{14, 0xd0, 0xD6, 0x37, 0x39, 0x6C, 0x7E, 0xBB, 0xCB}, nil},
...
func TestAddressUnmarshalBinary(t *testing.T) {
	patterns := []addressUnmarshalPattern{
		...
		{"alpha", []byte{14, 0xd1, 0xED, 0xF2, 0x7C, 0x1E, 0x3E, 0x97, 0xE7}, tpdu.Address{Addr: "messages", TOA: 0xd1}, 9, nil},
		{"alpha odd", []byte{13, 0xd1, 0xED, 0xF2, 0x7C, 0x1E, 0x3E, 0x97, 0x01}, tpdu.Address{Addr: "message", TOA: 0xd1}, 9, nil},
		{"alpha Vodafone", []byte{14, 0xd0, 0xD6, 0x37, 0x39, 0x6C, 0x7E, 0xBB, 0xCB}, tpdu.Address{Addr: "Vodafone", TOA: 0xd0}, 9, nil},
