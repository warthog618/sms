...
var marshalDeliverReportTestPatterns = []marshalDeliverReportTestPattern{
	{"minimal",
		DeliverReport{
			BaseTPDU: BaseTPDU{firstOctet: 0},
			fcs:      0x12,
		},
		[]byte{0x00, 0x12, 0x00},
		nil},
	{"full",
		DeliverReport{
			BaseTPDU: BaseTPDU{firstOctet: 0, pid: 0xab, dcs: 0x04, ud: []byte("report")},
			fcs:      0x12, pi: 0x07,
		},
	...
	{"bad ud",
		DeliverReport{
			BaseTPDU: BaseTPDU{firstOctet: 0, dcs: 0x80, ud: []byte("report")},
			fcs:      0x12, pi: 0x06},
		nil,
...
var unmarshalDeliverReportTestPatterns = []unmarshalDeliverReportTestPattern{
	...
	{"pid", []byte{0x00, 0x12, 0x01, 0xab},
		DeliverReport{
			BaseTPDU: BaseTPDU{firstOctet: 0, pid: 0xab},
			fcs:      0x12, pi: 0x01,
		},
		nil},
