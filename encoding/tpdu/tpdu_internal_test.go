...
func TestDecodeUserData(t *testing.T) {
	patterns := []struct {
		...
		{"nil",
			...
			nil,
			nil,
			DecodeError("udl", 0, ErrUnderflow),
		},
		{"empty",
			TPDU{},
			[]byte{0},
		...
		{"sm overlength 7bit",
			...
			nil,
			nil,
			DecodeError("sm", 1, ErrOverlength),
		},
		{"sm underflow",
			TPDU{},
		...
		{"odd ucs2",
			...
			nil,
			nil,
			DecodeError("sm", 1, ErrOddUCS2Length),
		},
		{"udh only",
			TPDU{FirstOctet: 0x40},
		...
		{"bad dcs",
			...
			nil,
			nil,
			DecodeError("alphabet", 1, ErrInvalid),
		},
		{"overlength",
			TPDU{FirstOctet: 0x40},
			...
			nil,
			nil,
			DecodeError("ud", 1, ErrOverlength),
		},
		{"short udh",
			TPDU{FirstOctet: 0x40},
			...
			nil,
			nil,
			DecodeError("udh.ie", 2, ErrUnderflow),
		},
		{"bad udh",
			TPDU{FirstOctet: 0x40},
			...
			nil,
			nil,
			DecodeError("udh.ied", 4, ErrUnderflow),
		},
	}
